"! @testing BDEF:ZRAP100_R_TRAVELP_RK
CLASS zcl_rap100_tc_travel_eml_rk DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
  ...
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP100_R_TRAVELP_RK' ) ) ).
...
*            FROM VALUE #( ( %cid_ref = 'ROOT1' ) )
    ...
    SELECT * FROM zrap100_r_travelp_rk INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
